...
def train(tpu=False):
    ...
    checkpoint = keras.callbacks.ModelCheckpoint('./checkpoints/classifier/classifier_{val_loss:.2f}.h5', monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=True)
